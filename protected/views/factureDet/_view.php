<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('facture_id')); ?>:</b>
	<?php echo CHtml::encode($data->facture_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_venc')); ?>:</b>
	<?php echo CHtml::encode($data->date_venc); ?>
	<br />
